    ...
    <section class="section back-black color-white py-30">
        <div class="equal-height-grid-top">
            <div class="grid-16 offset-1" data-aos="fade-right" data-aos-offset="300">
                ...
                <p>Confira a programação completa do <strong>V EBAR SUL - 2019</strong> clicando no botão abaixo.</p>
    ...
    <section class="section back-white color-black py-30">
        <div class="grid-34 offset-1" data-aos="fade-up" data-aos-offset="300">
            ...
            <img class="img-inline-block mx-20 img-ptr-00"
                 src="{{ url('images/lgo/prefeitura-de-uniao-da-vitoria.png') }}" alt="Prefeitura de União da Vitória">
        </div>
        <div class="grid-34 offset-1" data-aos="fade-up" data-aos-offset="300">
            ...
            <img class="img-inline-block mx-20 img-ptr-05"
                 src="{{ url('images/lgo/desigual-corretora-de-seguros.png') }}" alt="Desigual Corretora de Seguros">
        </div>
    </section>
